            ...
            {editingPhase === phase.id ? (
              <div className="flex items-center">
                <Input
                  ...
                  onChange={(e) => onEditPhaseValueChange(e.target.value)}
                  className="h-8 w-48"
                  onKeyDown={(e) => {
                    if (e.key === "Enter") {
                      onSavePhaseEdit();
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  variant="ghost"
                  size="icon"
                  onClick={() => onEditPhase(phase.id, phase.name)}
                  disabled={isSaving}
                  className={`${
                  ...
                  <div className="flex flex-col">
                    <div className="flex items-center">
                      <Switch
                        ...
                        onCheckedChange={() => onToggleActivation(phase.id)}
                      ...
                      />
                      <Label htmlFor={`activate-${phase.id}`} className="ml-2">
                        {phase.isActive ? "Deactivate Phase" : "Activate Phase"}
                      </Label>
                    </div>
                  </div>
                </div>
