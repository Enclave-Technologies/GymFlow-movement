...
import { downloadWorkoutPlanCsv, importWorkoutPlanFromCsv } from "./workout-plan-csv";
    ...
    const handleFileChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        reader.onload = (e) => {
            try {
                ...
                const parsedPhases = importWorkoutPlanFromCsv(content);
                ...
                setError((err as Error).message || "Failed to import workout plan");
            }
        };
    ...
    return (
        <div className="flex flex-col gap-4 mb-4">
            ...
            <Dialog open={showConfirmDialog} onOpenChange={setShowConfirmDialog}>
                <DialogContent>
                    <DialogHeader>
                        <DialogTitle>Replace Existing Workout Plan?</DialogTitle>
                        <DialogDescription>
                            This will replace the current workout plan with the imported one. This action cannot be undone.
                        </DialogDescription>
                    </DialogHeader>
                    ...
                    <div className="py-4">
                        ...
                        <ul className="list-disc list-inside mt-2 text-sm">
                            ...
                            <li>{importedPhases?.reduce((sum, phase) => sum + phase.sessions.length, 0) || 0} sessions</li>
                            <li>{importedPhases?.reduce((sum, phase) => 
                                sum + phase.sessions.reduce((s, session) => s + session.exercises.length, 0), 0) || 0} exercises</li>
                        </ul>
                    </div>
